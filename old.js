...
(async function() {
    ...
    const urls = [
        ...
        'https://football.fantasysports.yahoo.com/2018/f1/12200/matchup?mid1=4&mid2=2&week=16'
    ];
    ...
    for (i = 0; i < urls.length; i++) {
        ...
        const csvData = csvjson.toCSV(completedPlayerData, {
            headers: 'key'
        });

        fs.appendFile('./test/test-data-3.csv', csvData, (err) => {
            if (err) {
                console.log(err);
